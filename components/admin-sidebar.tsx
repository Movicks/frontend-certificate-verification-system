    ...
    >
      ...
      <div className="h-16 border-b border-sidebar-border flex items-center justify-between px-4">
        {!isCollapsed && (
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sidebar-foreground">SCVS Admin</span>
          </div>
        )}
      ...
      {!isCollapsed && user && (
        <div className="p-4 border-b border-sidebar-border">
          <p className="text-sm font-medium text-sidebar-foreground truncate">{user.institution?.name || user.name}</p>
